...
import com.movile.next.seriestracker.fragment.FavoritesFragment;
...
public class BaseNavigationDrawerActivity extends BaseLoadingActivity {
    ...
    private void configureNavigationDrawerContent() {
        getSupportFragmentManager().beginTransaction().add(R.id.base_navigation_drawer_content, FavoritesFragment.newInstance(), "favorites").commit();
    }
